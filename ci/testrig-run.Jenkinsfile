def configs = [
              //["sail", "piccolo", "rv32izicsr_zifencei_xcheri", "rv32izicsr_zifencei_xcheri", ""]
                ["sail", "flute", "rv64imsaczicsr_zifencei_xcheri", "rv64imsaczicsr_zifencei_xcheri", "", "'.*'", "'^(atomic(64)?|memAmo(64)?|float(64)?|caprandom|capmisc|double(64)?|hpm|csr|all|capdecode|pte)\$'"]
