def configs = [
              //["sail", "piccolo", "rv32izicsr_zifencei_xcheri", "rv32izicsr_zifencei_xcheri", ""]
                ["sail", "flute", "rv64imsafdczicsr_zifencei_xcheri", "rv64imsafdczicsr_zifencei_xcheri", "", "'.*'", "'^(compressed|atomic(64)?|memAmo(64)?|float(64)?|caprandom|capmisc|double(64)?|hpm|csr|all|capdecode|pte)\$'"]
        ...
        node('docker') {
          stage(name) {
            ...
            docker.image('ctsrd/testrig').inside {
              ...
              sh "mkdir coverage && /home/jenkins/sail/sailcov/sailcov -t /home/jenkins/TestRIG/sail_coverage -a /home/jenkins/TestRIG/riscv-implementations/sail-cheri-riscv/generated_definitions/c/all_branches --index index --prefix /home/jenkins/coverage/ `find /home/jenkins/TestRIG/riscv-implementations/sail-cheri-riscv -name '*.sail'`"
