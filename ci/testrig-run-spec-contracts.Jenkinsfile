        ...
        node('docker') {
          stage(name) {
            ...
            docker.image('ctsrd/testrig-pdr32').inside {
              ...
              sh "git -C /home/jenkins/TestRIG fetch --recurse-submodules && git -C /home/jenkins/TestRIG/ submodule sync && git -C /home/jenkins/TestRIG/ submodule update --init --recursive riscv-implementations/sail-cheri-riscv"
